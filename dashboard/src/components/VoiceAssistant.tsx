...
import { Mic, MicOff, Send, X, Loader2, Volume2, AlertCircle } from 'lucide-react';
...
export default function VoiceAssistant({ isOpen, onClose, scanResults }: VoiceAssistantProps) {
  ...
  return (
    <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50 p-4">
      <div className="bg-gray-900 rounded-lg border border-gray-700 w-full max-w-2xl h-[600px] flex flex-col">
        {/* Header */}
